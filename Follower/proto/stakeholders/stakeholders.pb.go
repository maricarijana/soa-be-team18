...
const file_stakeholders_stakeholders_proto_rawDesc = "" +
	"\n" +
	"\x1fstakeholders/stakeholders.proto\x12\fstakeholders\">\n" +
	...
	"\x13StakeholdersService\x12A\n" +
	"\bRegister\x12!.stakeholders.AccountRegistration\x1a\x12.stakeholders.User\x12G\n" +
	"\x0eGetAllAccounts\x12\x1a.stakeholders.PagedRequest\x1a\x19.stakeholders.AccountList\x12F\n" +
	"\x05Login\x12\x19.stakeholders.Credentials\x1a\".stakeholders.AuthenticationTokens\x12>\n" +
	"\tBlockUser\x12\x1a.stakeholders.BlockRequest\x1a\x15.stakeholders.AccountBGZ,soa/follower/proto/stakeholders;stakeholders\xaa\x02\x16GrpcServiceTranscodingb\x06proto3"
