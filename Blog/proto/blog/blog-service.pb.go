...
type CreateBlogRequest struct {
	...
	ImageBase64   string                 `protobuf:"bytes,6,opt,name=image_base64,json=imageBase64,proto3" json:"image_base64,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateBlogRequest) GetImageBase64() string {
	if x != nil {
...
const file_blog_blog_service_proto_rawDesc = "" +
	...
	"\ablog_id\x18\x02 \x01(\tR\x06blogId\x12\x16\n" +
	...
	"\fimage_base64\x18\x06 \x01(\tR\vimageBase64\"/\n" +
	...
	"\ablog_id\x18\x01 \x01(\tR\x06blogId\x12\x16\n" +
	...
	"\ablog_id\x18\x01 \x01(\tR\x06blogId\"0\n" +
	...
	"\n" +
	"\x06FAMOUS\x10\x042\xad\x03\n" +
	"\vBlogService\x12L\n" +
	"\n" +
	"CreateBlog\x12\x12.CreateBlogRequest\x1a\x13.CreateBlogResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/api/blogs\x12I\n" +
	"\bLikeBlog\x12\x10.LikeBlogRequest\x1a\x05.Blog\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/api/blogs/{blog_id}/like\x12h\n" +
	"\rCreateComment\x12\x15.CreateCommentRequest\x1a\x16.CreateCommentResponse\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/api/blogs/{blog_id}/comments\x12C\n" +
	"\bGetBlogs\x12\x10.GetBlogsRequest\x1a\x11.GetBlogsResponse\"\x12\x82\xd3\xe4\x93\x02\f\x12\n" +
	"/api/blogs\x12V\n" +
	"\vGetBlogById\x12\x13.GetBlogByIdRequest\x1a\x14.GetBlogByIdResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/api/blogs/{blog_id}B\fZ\n" +
