...
//        public override Task<TourReview> AddTourReview(AddTourRequest request, ServerCallContext context)
//        {
...
//                            ? DateTime.Parse(request.DateTour)
//                            : DateTime.UtcNow,
//                DateComment = !string.IsNullOrEmpty(request.DateComment)
//                            ? DateTime.Parse(request.DateComment)
//                            : DateTime.UtcNow
//            };

//            // Ako ima slika u Base64, sačuvaj ih
